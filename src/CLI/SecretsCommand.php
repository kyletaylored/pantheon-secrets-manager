...
class SecretsCommand extends WP_CLI_Command
{
    ...
    public function list($args, $assoc_args)
    {
        ...
        WP_CLI\Utils\format_items($assoc_args['format'], $data, ['id', 'label', 'pantheon_secret_name', 'php_constant_name', 'status']);
    }
    ...
    {
        $context = $args[0];
        if (!in_array($context, ['plugin', 'mu_plugin', 'manual'], true)) {
